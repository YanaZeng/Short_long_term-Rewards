            ...
            for mm in range(len(mumu)):
                for ss in range(len(sigma)):
                    ...
                    for j in range(1,trials+1):
                        ...
                        out_treat = np.loadtxt('data/IHDP/test/'+str(sub_mumu)+'_var'+str(sub_sigma)+'_beta_3_var1_' + str(j) + '.txt', delimiter=',')
